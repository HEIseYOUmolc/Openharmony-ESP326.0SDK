...
static const char *TAG = "ohos_target_generic";

static const ohos_port_board_profile_t s_profile = {
    .board_name = "esp32_generic",
    .uart_port = 0,
    .i2c_port = 0,
    .spi_host = 2,
    .gpio_demo_pin = 2,
...
{
    ESP_LOGW(TAG, "using generic target profile; create dedicated target port for best results");
}
